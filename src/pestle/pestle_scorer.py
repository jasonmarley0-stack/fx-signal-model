...
def category_scores(currency: str, client: SignalEngineClient | None = None, lookback_hours: int = 72) -> dict[str, float]:
...
def currency_pestle_score(currency: str, client: SignalEngineClient | None = None, lookback_hours: int = 72) -> tuple[float, dict[str, float]]:
...
def pair_pestle_score(pair: str, client: SignalEngineClient | None = None, lookback_hours: int = 72) -> dict:
